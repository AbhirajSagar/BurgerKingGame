...
const UnityComponent = () => {
  const { unityContext, unityProvider } = useUnityContext({
    loaderUrl: 'build/BurgerKingGame.loader.js',
    dataUrl: 'build/BurgerKingGame.data',
    frameworkUrl: 'build/BurgerKingGame.framework.js',
    codeUrl: 'build/BurgerKingGame.wasm',
  });
